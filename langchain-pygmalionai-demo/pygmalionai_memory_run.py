...
outputA = llm_chain.predict(human_input="Who are you?")
print(outputA)

outputB = llm_chain.predict(human_input="let me hug you")
print(outputB)

outputC = llm_chain.predict(human_input="I am in a bad mood")
print(outputC)